    ...
    public static class HttpHelper
    {
        ...
        public static async Task<HttpResults> GetRedirectWithWebCookie(string url, IDictionary<string, string> headers = null)
        {
            try
            {
                ...
                var cookies = fiter.CookieManager.GetCookies(new Uri(Constants.CookieGetDomain));
                //没有Cookie
                ...
                cookies = fiter.CookieManager.GetCookies(new Uri(Constants.CookieGetDomain));
                string cookie = "";
            ...
            {
                LogHelper.logger.Info("GET请求失败" + url, LogType.ERROR, ex);
